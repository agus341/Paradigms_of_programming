...
def imprimir_reporte(vehiculos: list):
    for vehiculo in vehiculos:
        vehiculo.mostrar_info()
        print(f"impuestos:{vehiculo.calcular_impuesto()}\n")

vehiculos = [Auto("Ford","Focus",10000000,5),Moto("Benelli","XR6",7000000,"Carrera")]
